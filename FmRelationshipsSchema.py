...
class RelationshipsSchema:
    def __init__(self, name):
        self.name = name
        self.fm_save_as_xml_file_path = "assets.xml"
        self.json_file_path = "relationship-schema.json"

    def ReadFile(self) -> str:
        """
        Returns the schema of database relationships as a JSON-formatted string.
        """
    ...
    def CreateFile(self):
        """
        Parses FmSaveAsXml to create the json file of database relationships.
        """

        with open(self.fm_save_as_xml_file_path, 'r', encoding='utf-8') as xml_file:
        ...
        try:
            ...
            for rel in relationships:
                ...
                if isinstance(left_field_name, tuple):
                    left_field_name = left_field_name[0] # accommodates a parser bug
                ...
                if isinstance(right_field_name, tuple):
                    right_field_name = right_field_name[0] # accommodates a parser bug
